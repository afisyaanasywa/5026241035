...
<body>
    <div class="container">
        <div class="jumbotron text-center">
            ...
            <p>More info</p>
            <p class="lead">
                <a class="btn btn-primary btn-lg" href="#" role="button">Klik di Sini</a>
            </p>
        </div>
        <!-- latihan grid 1-->
        <div class="row">
        ...
        <div class="row">
            <div class="col-8">
                <p class="open-sans-judul"><b>Danantara Indonesia</b> merupakan badan pengelola investasi yang
                    menangani, mengoptimalkan, dan
            ...
            <div class="col-4">
                <div class="row">
                    <div class="col">
                        <img src="https://www.danantaraindonesia.co.id/_next/image?url=https%3A%2F%2Fd19ypesdspgr78.cloudfront.net%2F490%2FHome_Intro_Small_Image.webp&w=3840&q=75"
                            class="img-fluid">
                    </div>
                </div>
                <div class="row">
